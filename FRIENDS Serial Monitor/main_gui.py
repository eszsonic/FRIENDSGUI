    ...
    def send_text_btn_r(self):
        ...
        with open(file_name3, 'w') as f3:
            ...
            for index, row in df.iterrows():
                if index + 1 < len(df) and row['Event'] == string1 and df.loc[index + 1, 'Event'] == string2:
                    ...
                    df3.loc[index, 'Event Duration'] = [duration]
                ...
                if row['Event'] == string5 or row['Event'] == string6:
                    df3 = df3.drop(index)

            f3.write(df3.to_string(index=False) + "\n")
        ...
        def generate_graph(df):
            ...
            for date in unique_dates:
                ...
                ax1.stem(np.arange(86400), time_matrix1, markerfmt=' ',linefmt='r', label="PUFF")
                ax1.set_ylabel(date)
                ax1.legend()
                ...
                ax2.stem(np.arange(86400), time_matrix2,markerfmt=' ', linefmt='b', label="TOUCH")
